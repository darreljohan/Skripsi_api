...
export class UserService {
  ...
  static async verifyToken(req: AuthUserRequest): Promise<AuthUserResponse> {
    const request = Validation.validate(UserValidationService.AUTH, req);
    ...
    if (result) {
      ...
      throw new AuthError(401, "Token not found");
    }
  }
}
